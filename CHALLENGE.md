...
Download the instructions and example input file from this repo and, once done, put all project files in a .zip file and send it to `apply@nuuvem.recruitee.com` or submit it via the Recruitee link you received, if any.
...
1. Be written in Ruby 2.7 or greater (or, in the language solicited by the job description, if any).
